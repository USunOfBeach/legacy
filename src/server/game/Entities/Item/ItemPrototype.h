...
enum ItemSubclassGeneric
{
    ...
    ITEM_SUBCLASS_TRAINING_WARRIOR              = 1,
    ITEM_SUBCLASS_TRAINING_PALADIN              = 2,
    ITEM_SUBCLASS_TRAINING_HUNTER               = 3,
    ITEM_SUBCLASS_TRAINING_ROGUE                = 4,
    ITEM_SUBCLASS_TRAINING_PRIEST               = 5,
    ITEM_SUBCLASS_TRAINING_DK                   = 6,
    ITEM_SUBCLASS_TRAINING_SHAMAN               = 7,
    ITEM_SUBCLASS_TRAINING_MAGE                 = 8,
    ITEM_SUBCLASS_TRAINING_WARLOCK              = 9,
    ITEM_SUBCLASS_TRAINING_DRUID                = 11
};

#define MAX_ITEM_SUBCLASS_GENERIC                 12
