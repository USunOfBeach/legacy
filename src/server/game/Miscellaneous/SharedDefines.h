...
#define CLASSMASK_ALL_PLAYABLE \
    ...
    (1<<(CLASS_DEATH_KNIGHT-1))|(1<<(CLASS_CIVILIAN-1)))
...
enum SpellAttr4
{
    ...
    SPELL_ATTR4_UNK28                            = 0x10000000, // 28 Aimed Shot - maybe hide castbar? test it. - nope.
...
enum SkillType
{
    ...
    SKILL_MAGICAL_MASSISM          = 789,
    SKILL_EXPLORE_N_ADVENTURE      = 790,
    SKILL_PRIMAL_FIRST_AID         = 791,
    SKILL_PRIMAL_COOKING           = 792,
    SKILL_PRIMAL_FISHING           = 793,
    SKILL_PRIMAL_HERBALISM         = 794,
    SKILL_PRIMAL_SKINNING          = 795,
    SKILL_PRIMAL_MINING            = 796,
    SKILL_PRIMAL_ENCHANTING        = 797,
    SKILL_PRIMAL_BLACKSMITHING     = 798,
    SKILL_PRIMAL_LEATHERWORKING    = 799,
    SKILL_PRIMAL_ACHEDAMY          = 800,
    SKILL_PRIMAL_TAILORING         = 801,
    SKILL_PRIMAL_ENGNEERING        = 802,
    SKILL_PRIMAL_GEMCRAFTING       = 803,
    SKILL_PRIMAL_INSCRIPTION       = 804,
    SKILL_STAT_STRENGTH            = 805,
    SKILL_STAT_AGILITY             = 806,
    SKILL_STAT_STAMINA             = 807,
    SKILL_STAT_INTELLECT           = 808,
    SKILL_STAT_SPIRIT              = 809,
    SKILL_GENERAL                  = 810,
    SKILL_CLASS_PRIMARY            = 811,
    SKILL_CLASS_SECONDARY          = 812,
    SKILL_CLASS_BENEFITS           = 813,
    SKILL_CHAR_WILD_HUNT           = 814,
    SKILL_CHAR_SHARPEN_BLADES      = 815,
    SKILL_CHAR_TOUGH_ARMOR         = 816
};

#define MAX_SKILL_TYPE               817
...
enum SkillCategory
{
	SKILL_CATEGORY_GATHERING     = 1,
    SKILL_CATEGORY_CHARACTER     = 2,
