...
enum AuraType
{
	...
	SPELL_AURA_MOD_RESIST_CHANCE							= 90,   // old SPELL_AURA_MOD_RESIST_CHANCE
    ...
    SPELL_AURA_MOD_DAMAGE_DONE_CREATURE_PCT                 = 317,
    SPELL_AURA_DEATH_ESCAPE                                 = 318,
    SPELL_AURA_PERIODIC_POWER_DAMAGE                        = 319,
    SPELL_AURA_POWER_SCHOOL_ABSORB                          = 320,
    SPELL_AURA_PERIODIC_POWER_HEAL                          = 321,
    SPELL_AURA_PERIODIC_POWER_LEECH                         = 322,
	SPELL_AURA_MOD_REST_XP_GENERATE_RATE					= 323,
    SPELL_AURA_MOD_DUALWIELD_MELEE_HASTE                    = 324,
    SPELL_AURA_DRAIN_HEALTH_FROM_MECHANIC_DAMAGE            = 325,
    SPELL_AURA_PREVENT_POWER_LOSS_AT_PCT_NOT_STACK          = 326,
    SPELL_AURA_SHARE_HEAL_FROM_PARTY_NOT_STACK              = 327,
    SPELL_AURA_MOD_CRIT_DAMAGE_MELEE                        = 328,
    SPELL_AURA_MOD_CRIT_DAMAGE_RANGED                       = 329,
    SPELL_AURA_MOD_CRIT_DAMAGE_SPELL                        = 330,
    SPELL_AURA_REDUCE_MASS_DAMAGE                           = 331,
    TOTAL_AURAS                                             = 332
};
