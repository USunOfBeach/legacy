...
#define MAX_TALENT_TABS 1
#define MAX_TALENT_DEPENDENCY 3
...
struct TalentEntry
{
    ...
    uint32    DependsOn[MAX_TALENT_DEPENDENCY];                                    // 13 index in Talent.dbc (TalentEntry)
                                                            // 14-15 not used
    uint32    DependsOnRank[MAX_TALENT_DEPENDENCY];                                // 16
                                                            // 17-18 not used
