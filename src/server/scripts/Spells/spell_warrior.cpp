    ...
    public:
        ...
        class spell_warr_bloodthirst_SpellScript : public SpellScript
        {
            ...
            void HandleDamage(SpellEffIndex /*effIndex*/)
            {
                ...
                int32 damage = GetCaster()->GetTotalAttackPowerValue(BASE_ATTACK) * 1.2;
            ...
            {
                OnEffectHitTarget += SpellEffectFn(spell_warr_bloodthirst_SpellScript::HandleDamage, EFFECT_0, SPELL_EFFECT_POWER_DAMAGE);
    ...
    public:
        ...
        class spell_warr_concussion_blow_SpellScript : public SpellScript
        {
            ...
            void HandleHit(SpellEffIndex /*effIndex*/)
            {
                ...
                {
                    if (victim->GetHealthPct() <= 75)
                        GetCaster()->CastSpell(victim, 80882);
                    if (victim->GetHealthPct() <= 25)
                        GetCaster()->CastSpell(victim, 80883);
                }
            }

            void Register() override
            {
                OnEffectHitTarget += SpellEffectFn(spell_warr_concussion_blow_SpellScript::HandleHit, EFFECT_0, SPELL_EFFECT_WEAPON_PERCENT_DAMAGE);
            }
        };
        ...
        class spell_warr_execute_SpellScript : public SpellScript
        {
            ...
            void HandleEffect(SpellEffIndex effIndex)
            {
                ...
                if (Unit* target = GetHitUnit())
                {
                    ...
                    int32 rageUsed = std::min<int32>(caster->GetMaxPower(POWER_RAGE) - spellInfo->CalcPowerCost(caster, SpellSchoolMask(spellInfo->SchoolMask)), caster->GetPower(POWER_RAGE));
                    ...
                    int32 bp = caster->GetTotalAttackPowerValue(BASE_ATTACK) * 3 * ((float)rageUsed / 250.0f + 1);
        ...
        class spell_warr_slam_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
                if (GetHitUnit())
                    ...
                    GetCaster()->CastSpell(GetHitUnit(), 50783, TRIGGERED_FULL_MASK);
            }
