...
class spell_pri_power_word_shield : public SpellScriptLoader
{
    public:
        ...
        class spell_pri_power_word_shield_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_pri_power_word_shield_AuraScript::CalculateAmount, EFFECT_0, SPELL_AURA_POWER_SCHOOL_ABSORB);
...
class spell_pri_renew : public SpellScriptLoader
{
    public:
        ...
        class spell_pri_renew_AuraScript : public AuraScript
        {
            ...
            void Register() override
            {
                OnEffectApply += AuraEffectApplyFn(spell_pri_renew_AuraScript::HandleApplyEffect, EFFECT_0, SPELL_AURA_PERIODIC_POWER_HEAL, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
            }
        };
