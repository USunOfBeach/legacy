...
public:
    ...
    ChatCommand* GetCommands() const override
    {
        static ChatCommand eventCommandTable[] =
        {
			...
			{ "lexecute",	rbac::RBAC_PERM_COMMAND_EVENT_STOP,	      true, &HandleLegacyEventExecuteCommand,"", NULL },
	...
	static bool HandleLegacyEventExecuteCommand(ChatHandler* handler, char const* args)
	{
		if (!*args)
			return false;

		uint32 eventId = (uint32)atoi((char*)args);

		xEventMgr->SetEventStage(eventId, 2);
